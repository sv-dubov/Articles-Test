            ...
            <div class="col-4 pb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-3">
                            <span class="badge bg-primary">{{$article->stats->likes}} <i class="far fa-thumbs-up"></i></span>
                            <span class="badge bg-danger">{{$article->stats->views}} <i class="far fa-eye"></i></span>
                        </div>
                        <div class="mt-4">
                            Tags:
